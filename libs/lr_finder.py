...
class LRFinder(object):
    ...
    def range_test(
            self,
            train_set: 'DataContainer',
            val_set='DataContainer',
            start_lr=None,
            end_lr=10,
            num_iter=100,
            step_mode="exp",
        ...
        train_batches = iter(train_set.batch(50))
        val_batches = iter(val_set.batch(50))
        ...
        for iteration in tqdm(range(num_iter)):
            ...
            if val_set:
                loss = self._validate(val_batches, non_blocking_transfer=non_blocking_transfer)
