...
def distribute(label_list,
    ...
    """
        ...
        ----------
            ...
            classes: the number of classification (e.genetic_selectors_v2., 10 for CIFAR-10) OR a list of segmentation categories
...
def partition_class_samples_with_dirichlet_distribution(N, alpha, client_num, idx_batch, idx_k):
    ...
    # e.genetic_selectors_v2., when client_num = 4, proportions = [0.29543505 0.38414498 0.31998781 0.00043216], sum(proportions) = 1
