...
initial_model = initializer.cluster_module_creator(client_data, lambda: c_model, config['nb_clusters'],
                                                   config['ga_c_size'], epochs=500, batch=50, lr=args.learn_rate,
                                                   saved_model_path=f'./kcenter{args.dataset}{args.learn_rate}')
