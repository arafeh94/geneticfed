...
args.tag = 'cnn_cifar10_dirichlet'
...
# client_data = preload(args.dataset, DirichletDistributor(100, 10, args.shard))
client_data = preload('cifar10', DirichletDistributor(100, 10, args.shard))
