...
split_fast = SplitFed(copy.deepcopy(server_model), copy.deepcopy(client_model), fast, test_data, 1, 0.001, True)
split_slow = SplitFed(copy.deepcopy(server_model), copy.deepcopy(client_model), slow, test_data, 1, 0.001, True)
