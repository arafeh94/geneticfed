...
from apps.donotuse.dbs.test import EncryptionClient
...
client_data = preload('mnist', ShardDistributor(300, 1))
...
trainer_params = TrainerParams(trainer_class=EncryptionClient, optimizer='sgd', epochs=config['epochs'],
...
federated.add_subscriber(SQLiteLogger('session_mario', f'cached_results.db', config))
