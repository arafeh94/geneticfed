...
key_tests = {
    ...
    'main_splitfed': test_cases.build({
        'epoch': [1],
        'batch': [25],
        'round': [100],
        'client_ratio': [10],
        'dataset': ['mnist'],
        'learn_rate': [0.1],
        'script': ['main_splitfed'],
        'tag': ['wd1'],
        'distributor': ['mnist_c10_label_1']
    }),
    'main_splitfed_cluster': test_cases.build({
        'epoch': [1],
        'batch': [25],
        'round': [100],
        'client_ratio': [10],
        'dataset': ['mnist'],
        'learn_rate': [0.1],
        'script': ['main_splitfed_cluster'],
        'tag': ['wd1'],
        'distributor': ['mnist_c10_label_1']
    }),
    'main_splitfed_cluster_faster': test_cases.build({
        'epoch': [1],
        'batch': [25],
        'round': [100],
        'client_ratio': [10],
        'dataset': ['mnist'],
        'learn_rate': [0.1],
        'script': ['main_splitfed_cluster_faster'],
        'tag': ['wd1'],
        'distributor': ['mnist_c10_label_1']
    }),
}
